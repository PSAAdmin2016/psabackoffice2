...
import com.psabackoffice.psa.service.FeedBackService;
...
public class FeedBackController {
    ...
    public FeedBack createFeedBack(@RequestBody FeedBack feedBack) {
		...
		LOGGER.debug("Created FeedBack with information: {}" , feedBack);
...
public FeedBack getFeedBack(@PathVariable("id") Integer id) {
    ...
    public FeedBack editFeedBack(@PathVariable("id") Integer id, @RequestBody FeedBack feedBack) {
        ...
        LOGGER.debug("FeedBack details with id: {}" , feedBack);
...
public boolean deleteFeedBack(@PathVariable("id") Integer id) {
	...
	@ApiOperation(value = "Returns the total count of FeedBack instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
    ...
    public Page<FeedBackNotes> findAssociatedFeedBackNoteses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return feedBackService.findAssociatedFeedBackNoteses(id, pageable);
    }
