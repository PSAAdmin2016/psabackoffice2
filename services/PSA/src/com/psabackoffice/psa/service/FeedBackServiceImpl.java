...
public class FeedBackServiceImpl implements FeedBackService {
	...
	public FeedBack create(FeedBack feedBack) {
        ...
        if(feedBackCreated.getFeedBackNoteses() != null) {
            for(FeedBackNotes feedBackNotese : feedBackCreated.getFeedBackNoteses()) {
                feedBackNotese.setFeedBack(feedBackCreated);
