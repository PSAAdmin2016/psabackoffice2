...
public class ChatConversationsServiceImpl implements ChatConversationsService {
	...
	public ChatConversations create(ChatConversations chatConversations) {
        ...
        if(chatConversationsCreated.getChatConversationMemberses() != null) {
            for(ChatConversationMembers chatConversationMemberse : chatConversationsCreated.getChatConversationMemberses()) {
                chatConversationMemberse.setChatConversations(chatConversationsCreated);
        ...
        if(chatConversationsCreated.getChatMessageses() != null) {
            for(ChatMessages chatMessagese : chatConversationsCreated.getChatMessageses()) {
                chatMessagese.setChatConversations(chatConversationsCreated);
