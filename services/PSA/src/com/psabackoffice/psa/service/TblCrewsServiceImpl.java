...
public class TblCrewsServiceImpl implements TblCrewsService {
	...
	public TblCrews create(TblCrews tblCrews) {
        ...
        if(tblCrewsCreated.getTblCrewsRevs() != null) {
            for(TblCrewsRev tblCrewsRev : tblCrewsCreated.getTblCrewsRevs()) {
                tblCrewsRev.setTblCrews(tblCrewsCreated);
                LOGGER.debug("Creating a new child TblCrewsRev with information: {}", tblCrewsRev);
                tblCrewsRevService.create(tblCrewsRev);
            }
        }
