...
public class RefCraftsServiceImpl implements RefCraftsService {
	...
	public RefCrafts create(RefCrafts refCrafts) {
        ...
        if(refCraftsCreated.getTblUserPsas() != null) {
            for(TblUserPsa tblUserPsa : refCraftsCreated.getTblUserPsas()) {
                tblUserPsa.setRefCrafts(refCraftsCreated);
                LOGGER.debug("Creating a new child TblUserPsa with information: {}", tblUserPsa);
                tblUserPsaService.create(tblUserPsa);
            }
        }
        return refCraftsCreated;
    }
	...
	public RefCrafts getById(Integer refcraftsId) throws EntityNotFoundException {
        ...
        RefCrafts refCrafts = this.wmGenericDao.findById(refcraftsId);
        if (refCrafts == null){
	...
	public RefCrafts update(RefCrafts refCrafts) throws EntityNotFoundException {
        ...
        Integer refcraftsId = refCrafts.getId();
