...
public class RefStateAbbreviationsServiceImpl implements RefStateAbbreviationsService {
	...
	public RefStateAbbreviations create(RefStateAbbreviations refStateAbbreviations) {
        ...
        if(refStateAbbreviationsCreated.getTblJobSiteses() != null) {
            for(TblJobSites tblJobSitese : refStateAbbreviationsCreated.getTblJobSiteses()) {
                tblJobSitese.setRefStateAbbreviations(refStateAbbreviationsCreated);
                LOGGER.debug("Creating a new child TblJobSites with information: {}", tblJobSitese);
                tblJobSitesService.create(tblJobSitese);
            }
        }
