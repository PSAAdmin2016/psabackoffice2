...
public class RefCraftClassesServiceImpl implements RefCraftClassesService {
	...
	public RefCraftClasses create(RefCraftClasses refCraftClasses) {
        ...
        if(refCraftClassesCreated.getTblUserPsas() != null) {
            for(TblUserPsa tblUserPsa : refCraftClassesCreated.getTblUserPsas()) {
                tblUserPsa.setRefCraftClasses(refCraftClassesCreated);
