...
/**
 * LandingTrackerCivil generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`LandingTrackerCivil`")
public class LandingTrackerCivil implements Serializable {
    ...
    @Column(name = "`SortGroup1`", nullable = false, length = 255)
    ...
    @Column(name = "`SortGroup2`", nullable = true, length = 255)
    ...
    @Column(name = "`SortGroup3`", nullable = true, length = 255)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LandingTrackerCivil)) return false;
        final LandingTrackerCivil landingTrackerCivil = (LandingTrackerCivil) o;
        return Objects.equals(getUid(), landingTrackerCivil.getUid());
    }
