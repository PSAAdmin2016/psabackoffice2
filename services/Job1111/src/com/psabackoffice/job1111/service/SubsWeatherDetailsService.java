...
public interface SubsWeatherDetailsService {
     ...
     */
	SubsWeatherDetails create(SubsWeatherDetails subsWeatherDetails);
	 ...
	 */
	SubsWeatherDetails update(SubsWeatherDetails subsWeatherDetails) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated subsDetailses for given SubsWeatherDetails id.
     *
