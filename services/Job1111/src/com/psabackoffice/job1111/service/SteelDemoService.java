...
public interface SteelDemoService {
    ...
    /*
     * Returns the associated steelDemoRevs for given SteelDemo id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated SteelDemoRev instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<SteelDemoRev> findAssociatedSteelDemoRevs(Integer id, Pageable pageable);
