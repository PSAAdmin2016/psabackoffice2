...
/**
 * EquipTrackerDetailsRev generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`EquipTrackerDetailsREV`")
public class EquipTrackerDetailsRev implements Serializable {

    private Integer uid;
    private int fkOrgUid;
    private int bidId;
    ...
    @Column(name = "`fk_OrgUID`", nullable = false, scale = 0, precision = 10)
    public int getFkOrgUid() {
        return this.fkOrgUid;
    }

    public void setFkOrgUid(int fkOrgUid) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EquipTrackerDetailsRev)) return false;
        final EquipTrackerDetailsRev equipTrackerDetailsRev = (EquipTrackerDetailsRev) o;
        return Objects.equals(getUid(), equipTrackerDetailsRev.getUid());
    }
