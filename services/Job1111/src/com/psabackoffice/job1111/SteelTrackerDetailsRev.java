...
/**
 * SteelTrackerDetailsRev generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`SteelTrackerDetailsREV`")
public class SteelTrackerDetailsRev implements Serializable {

    private Integer uid;
    private Integer fkOrgUid;
    private int bidId;
    ...
    @Column(name = "`fk_OrgUID`", nullable = true, scale = 0, precision = 10)
    public Integer getFkOrgUid() {
        return this.fkOrgUid;
    }

    public void setFkOrgUid(Integer fkOrgUid) {
        this.fkOrgUid = fkOrgUid;
    }
    ...
    @Column(name = "`Weight`", nullable = true, scale = 6, precision = 13)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SteelTrackerDetailsRev)) return false;
        final SteelTrackerDetailsRev steelTrackerDetailsRev = (SteelTrackerDetailsRev) o;
        return Objects.equals(getUid(), steelTrackerDetailsRev.getUid());
    }
